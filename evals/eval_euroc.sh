...
for dataset in ${datasets[@]}; do
    ...
    python main.py --image_folder $dataset_name  --max_loops 1 --conf_threshold 25 --lc_thres 0.9 --vis_map --log_results --log_path $dataset.txt --min_disparity 50 --submap_size 16
